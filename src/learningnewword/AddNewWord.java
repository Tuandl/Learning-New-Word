...
public class AddNewWord extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        txtJapanese = new javax.swing.JTextField();
        ...
        setMaximizedBounds(new java.awt.Rectangle(0, 0, 1000000000, 250));
        ...
        txtJapanese.setFont(new java.awt.Font("DengXian", 0, 18)); // NOI18N
        txtJapanese.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtJapaneseActionPerformed(evt);
            }
        });
        ...
        txtVietnamese.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        bnSave.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        bnSave.setText("Save");
        ...
        bnDone.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        bnDone.setText("Done");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(bnSave, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(bnDone, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txtJapanese, javax.swing.GroupLayout.DEFAULT_SIZE, 340, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(txtJapanese, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void bnDoneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnDoneActionPerformed
        //BridgeData.setDestination(BridgeData.DESTINATION_WORDS_LIST);
        this.dispose();
    ...
    private void bnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnSaveActionPerformed
        Word newWord = new Word(txtJapanese.getText(), txtEnglish.getText(), 
                txtVietnamese.getText());
        WordsList.addWord(newWord);
        txtEnglish.setText("");
        txtJapanese.setText("");
    ...
    private void txtJapaneseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtJapaneseActionPerformed
        txtEnglish.requestFocus();
    }//GEN-LAST:event_txtJapaneseActionPerformed

    private void txtEnglishActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtEnglishActionPerformed
        txtVietnamese.requestFocus();
    ...
    private javax.swing.JTextField txtJapanese;
